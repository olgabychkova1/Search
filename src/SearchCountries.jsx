...
class Search extends React.Component {
    ...
    onChangeHandler(e) {
        // ДОБАВИТЬ ЛОГИКУ ОЧИСТИ СТРАН ЕСЛИ ЗНАЧЕНМЕ ПУСТОЕ
        var newCountries = COUNTRIES.filter((d) => {
    ...
    render() {
        return (
            <div>
                <input type="text" placeholder="Coutries" onChange={this.onChangeHandler} />
                <p>
                    { 
                        // строку изменить
